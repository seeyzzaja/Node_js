...
export declare const createProducts: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const updateProducts: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const deleteProducts: (req: Request, res: Response, next: import("express").NextFunction) => void;
